...
async function seed() {
  ...
  console.log('  cd apps/server && bun run dev')
  console.log()
  console.log('  Run the frontend:')
  console.log('  cd apps/client && VITE_API_URL=http://localhost:3001 bun run dev')
  console.log()
  console.log('  Then open:')
  console.log(`  http://localhost:5173/?token=${token}`)
  console.log()
  console.log('  For MCP server:')
  console.log('  cd apps/mcp && EXPENSE_API_KEY=<api-key> bun run dev')
  console.log('══════════════════════════════════════════\n')
}
